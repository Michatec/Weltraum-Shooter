...
pygame_icon = pygame.image.load('assets/game.ico')
...
def main():
    ...
    def redraw_window():
        ...
        if lost:
            lost_label = lost_font.render("Du hast Verloren!!", 1, (10,148,253))
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0,0))
        title_label = title_font.render("Drück die Maus zu beginnen...", 1, (255,255,255))
